...
export default function Springbok4Page() {
  
  // Define the data that will be passed to the template
  const campaignData = {
    title: "ULT Dream Careers Lion Charity Collection",
    imageUrl: "https://deins.s3.eu-central-1.amazonaws.com/images/ubu4.png", // Assuming this is the correct path to your image
    descriptionHtml: `
